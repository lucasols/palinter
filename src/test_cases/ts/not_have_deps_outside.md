...
expected_errors:
  - "File ./src/ok/fileA.ts:\n • disallowed dependencies outside folders '@src/ok/*' found: @src/ok/fileB.ts > @src/tests/fileC.ts"
  - "File ./src/ok/fileB.ts:\n • disallowed dependencies outside folders '@src/ok/*' found: @src/tests/fileC.ts"
```
