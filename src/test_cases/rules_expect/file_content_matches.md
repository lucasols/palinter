...
expected_errors:
  - "File './contentAtMost/file.ts' error: content should match at most 1 of the configured patterns"
```
...
expected_errors:
  - "File './contentAtLeast/file.ts' error: content should match at least 2 of the configured patterns"
```
...
expected_errors:
  - "File './contentAtLeast2/file.ts' error: content should match at least 2 of the configured patterns"
```
